...
import org.jbls.util.Out;
import org.jbls.util.PE;
...
public class HashMain {
    ...
    public static String getExeInfo(int prod, String[] files) {
    ...
    public static int getExeVer(int prod, String[] files) {
    ...
    public static int getChecksum(int prod, String formula, int dll, String[] files){
		return getChecksum(prod, formula, dll, PLATFORM_INTEL, 2, files);
    }
    public static int getChecksum(int prod, String formula, int dll, int platform, int ver, String[] files){
    	//String[] files = null;
    	try{
    ...
    public static int getChecksum(int prod, String formula, String dll, long filetime, String[] files){
      if(dll.matches("ver-IX86-[0-7].mpq") == true) return getChecksum(prod, formula, dll.charAt(9) - 0x30, PLATFORM_INTEL, 2, files);
      if(dll.matches("ver-XMAC-[0-7].mpq") == true) return getChecksum(prod, formula, dll.charAt(9) - 0x30, PLATFORM_MACOSX, 2, files);
      if(dll.matches("ver-PMAC-[0-7].mpq") == true) return getChecksum(prod, formula, dll.charAt(9) - 0x30, PLATFORM_POWERPC, 2, files);

      if(dll.matches("IX86ver-[0-7].mpq") == true) return getChecksum(prod, formula, dll.charAt(7) - 0x30, PLATFORM_INTEL, 1, files);
      if(dll.matches("XMACver-[0-7].mpq") == true) return getChecksum(prod, formula, dll.charAt(7) - 0x30, PLATFORM_MACOSX, 1, files);
      if(dll.matches("PMACver-[0-7].mpq") == true) return getChecksum(prod, formula, dll.charAt(7) - 0x30, PLATFORM_POWERPC, 1, files);
